...
namespace ChronoForce.Screens
{
    ...
    class BattleScreen : GameScreen
    {
        ...
        // Local reference of the engine to handle all battle statistics
        ...
        {
            // Store a local pointer to the battle engine
            battleEngine = ScreenManager.GameEngine.Battle;

            // Create the menu screen
            menuScreen = new BattleMenuScreen(battleEngine, new Vector2(10, 480));
            ...
            List<CharacterBase> testList = new List<CharacterBase>(ChronoConstants.cMaxPartyMembers);
            ...
            List<CharacterBase> enemyList = new List<CharacterBase>(ChronoConstants.cMaxPartyMembers);
            ...
            battleEngine.initializeEngine(testParty, enemyParty);

            // Create the battle director
            battleDirector = new BattleDirector(battleEngine, battleFont, ScreenManager.Arrow);
        }
        ...
        public void AttackHandler(object o, NumberEventArgs e)
        {
            ...
            battleDirector.CreateAttack(battleEngine.PlayerParty[e.ID], battleEngine.EnemyParty[e.Target]);
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.DrawString(battleFont, battleEngine.PlayerParty[i].Name, new Vector2(365, y), Color.White, 0,
                    Vector2.Zero, 1, SpriteEffects.None, 0);
                spriteBatch.DrawString(battleFont, "999", new Vector2(525, y), Color.White, 0,
                    Vector2.Zero, 1, SpriteEffects.None, 0);
                spriteBatch.DrawString(battleFont, "999", new Vector2(557, y + 4), Color.White, 0,
                ...
                spriteBatch.Draw(battleTimer, new Vector2(680, y),
                    new Rectangle(0, 0, (int)(battleEngine.PlayerParty[i].TimerPercent * 100), 20), Color.White);
