...
namespace ChronoForceREMOVE.Engine.Actions
{
    /// <summary>
    ...
    public class ActionSlot
    {
        ...
        /// </summary>
        public class ActionSlotReader : ContentTypeReader<ActionSlot>
        {
            /// <summary>
            /// Reads a ActionSlot object from the content pipeline.
            /// </summary>
            protected override ActionSlot Read(ContentReader input,
                ActionSlot existingInstance)
            {
                ActionSlot member = existingInstance;
                if (member == null)
                {
                    //member = new ActionSlot();
                }
